export default class ProductExpensesNav {
  searchBar() {
    ...
    search_input.placeholder = "search product expenses";
  ...
  buttons() {
    ...
    add_expense_button.textContent = "add product";
    add_expense_button.addEventListener("click", () => {
      location = "/add_product_expense";
    });

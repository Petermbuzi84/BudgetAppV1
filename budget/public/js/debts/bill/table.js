...
import EditBillDebt from "../edit/bill/main.js";
import PayBillDebt from "./pay/main.js";

export default class BillDebtsTable extends Table {
  constructor(debts) {
    super();
    this.debts = debts;
    this.pay_debt = new PayBillDebt();
  }
  ...
  tableContents(element) {
    this.debts.forEach((debt, index) => {
      ...
      this.tableItemActions(
        ...
        { data: this.debts, edit_form: EditBillDebt },
        { action: "remove_debt/bills", redirect: "bills" }
      ),
        element.append(row);
    });
  }
